...
module.exports = {
    ...
    'supersecret': this.secret+absolutePath, //absolutepath to config file included (this will not work with many nodes of the app, absolute path have to be removed then)
    'tokenLifeTime': process.env.TTL, // || 1140, //todo consider 1440 or lower
